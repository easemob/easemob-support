...
export declare namespace EasemobChat {
  ...
  type onChatThreadChangeType = "create" | "update" | "destroy" | "userRemove";
  ...
  class Connection {
    ...
    addUsersToChatRoomWhitelist(
      ...
      params: {
        ...
        users: string[];
        success?: (
          res: AsyncResult<CommonRequestResult | CommonRequestResult[]>
        ) => void;
        error?: (error: ErrorEvent) => void;
      }
    ...
    getJoinedGroups(
      ...
      params: {
         ...
         */
        needRole?: boolean;
        success?: (res: AsyncResult<BaseGroupInfo[] | GroupInfo[]>) => void;
        error?: (error: ErrorEvent) => void;
      }
     ...
     * ```
     */
    addContact(this: Connection, to: string, message?: string): Promise<void>;
  ...
  class Message {
    ...
    create(options: CreateMsgType): MessageBody;
    /** @deprecated */
